package br.org.projetointegrador.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.projetointegrador.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Ecoleta")
			.description("Projeto API Spring - Ecoleta")
			.version("1.0.0")
	...
	private static Contact contact() {
		return new Contact("Vinicius Barreto, Mayara Machado, Maicon Bonfim, Marcus Vinicius", 
				"https://github.com/vinibol22,https://github.com/mayara008,https://github.com/maytech474,https://github.com/marcusvinicius21 ","vinicius.vbb98@gmail.com");
